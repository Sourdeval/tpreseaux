...
public class Buoy {
	...
	private final IntegerProperty dataCount;
	...
	public Buoy() {
		...
		this.dataCount = new SimpleIntegerProperty(0);
	}
	...
	public IntegerProperty getDataCount() {
		return dataCount;
	}
	...
	public void setWith (Buoy buoy) {
		if (buoy == null) {
			...
			this.getDataCount().set(buoy.getDataCount().get());
		}
	}
